...
// `action` events — a real container image the chart's Deployment needs, same as the
// others; migrate is required too — the chart's migration Job can't run without its own
